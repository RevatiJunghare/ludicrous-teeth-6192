            ...
            <Container as={Stack} maxW={'6xl'} py={10}>
                <h3 style={{textAlign:"left",fontSize:"20px"}} >FAQ</h3>
                 <div style={{textAlign:"left"}}>
                     <p style={{fontWeight:"bold"}}>How is Licious chicken sourced?</p>
                     <p>Licious chicken is a premium produce that ensures you enjoy quality and fresh meat. We work with local farmers and the chicken is raised in a natural environment on controlled farms.</p>
                     <p style={{fontWeight:"bold"}}>Why should I choose Licious chicken?</p>
                     <p>We strive to bring you only the best! We are extremely meticulous about the meat we put on your plate. For this reason, our chicken produce is handpicked. We believe that chicken tastes best when fresh and it truly uplifts the taste of your meals. Moreover, chicken from Licious is free from antibiotic residue and artificially injected hormones.</p>
                     <p style={{fontWeight:"bold"}}>How long can I store chicken in the refrigerator?</p>
                     <p>Chicken is best consumed fresh or on the day of its delivery, as it adds the best flavours to your dish. We do not recommend using frozen chicken, as it affects the taste, texture and nutritional properties of the meat. However, the meat, whether whole or cut, can be stored in a refrigerator for 2 to 3 days.</p>
                 </div>
      ...
      <Box
        ...
        <Box py={10}>
          ...
          <Text pt={6} fontSize={'sm'} textAlign={'center'}>
            © 2022 fRito All rights reserved
          </Text>
        </Box>
      </Box>
